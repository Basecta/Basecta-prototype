...
A SaaS prototype for tracking and monitoring agricultural biodiversity metrics on Irish farmland (hedgerows, waterways, and soil data) for ACRES agri-environmental compliance reporting.

Built between January and April 2026, the prototype attracted paying-party interest from agri-environmental consultants. Those conversations clarified the real product requirements and prompted the rebuild in a more appropriate stack.
...
The prototype's job was to get something working fast, get it in front of consultants, and find out what they'd actually pay for. With that done, the production system is being built in Java / Spring Boot, a better fit for the long-term scope of the project.
